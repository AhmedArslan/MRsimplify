...
exposures_clump_local_preH <- ld_clump(dplyr::tibble(rsid=exposures$SNP, pval=exposures$pval, id=exposures$Phenotype), plink_bin = genetics.binaRies::get_plink_binary(), bfile = "/path/to/LD/EUR")
